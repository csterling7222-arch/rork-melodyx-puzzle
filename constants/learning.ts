...
export const SKILL_INFO: Record<SkillCategory, { name: string; icon: string; color: string; description: string }> = {
  earTraining: { name: 'Ear Training', icon: '👂', color: '#A78BFA', description: 'Recognize pitches and intervals by ear' },
  rhythm: { name: 'Rhythm', icon: '🥁', color: '#F59E0B', description: 'Master timing, tempo, and rhythmic patterns' },
  melodyRecognition: { name: 'Melody Recognition', icon: '🎵', color: '#22C55E', description: 'Identify and remember melodic phrases' },
  noteAccuracy: { name: 'Note Accuracy', icon: '🎯', color: '#EF4444', description: 'Hit the right notes consistently' },
  improvisation: { name: 'Improvisation', icon: '🎸', color: '#EC4899', description: 'Create music spontaneously' },
  harmony: { name: 'Harmony', icon: '🎼', color: '#06B6D4', description: 'Understand chord progressions and voicings' },
  sightReading: { name: 'Sight Reading', icon: '📖', color: '#8B5CF6', description: 'Play music at first sight' },
  composition: { name: 'Composition', icon: '✍️', color: '#10B981', description: 'Create original musical pieces' },
  theory: { name: 'Theory', icon: '📚', color: '#F97316', description: 'Understand music fundamentals' },
};
...
export const PRACTICE_MODE_INFO: Record<PracticeMode, { name: string; description: string; icon: string; xpBonus: number; color: string }> = {
  standard: { name: 'Standard', description: 'Listen and repeat the melody exactly', icon: '🎵', xpBonus: 1, color: '#22C55E' },
  mirror: { name: 'Mirror Mode', description: 'Play the melody in reverse order', icon: '🪞', xpBonus: 1.5, color: '#A78BFA' },
  harmony: { name: 'Harmony Builder', description: 'Add your own harmony to the melody', icon: '🎼', xpBonus: 1.75, color: '#06B6D4' },
  improvisation: { name: 'Improv Jam', description: 'Create variations on the theme', icon: '🎸', xpBonus: 2, color: '#EC4899' },
  speed: { name: 'Speed Run', description: 'Master the melody at increasing tempos', icon: '⚡', xpBonus: 1.5, color: '#F59E0B' },
  zen: { name: 'Zen Practice', description: 'Relaxed mindful practice, no time pressure', icon: '🧘', xpBonus: 1.25, color: '#10B981' },
  duet: { name: 'AI Duet', description: 'Play alongside an AI accompanist', icon: '🤝', xpBonus: 1.75, color: '#8B5CF6' },
  challenge: { name: 'Challenge Mode', description: 'Compete against the clock', icon: '🏆', xpBonus: 2.5, color: '#EF4444' },
};
...
export const POWER_UPS: PowerUp[] = [
  { id: 'tempo_boost', name: 'Tempo Boost', description: 'Slow down playback for easier learning', icon: '🐢', effect: 'tempo_boost', duration: 60, cost: 50, unlockLevel: 3 },
  { id: 'hint_shield', name: 'Hint Shield', description: 'Get an extra hint without penalty', icon: '🛡️', effect: 'hint_shield', duration: 1, cost: 30, unlockLevel: 2 },
  { id: 'harmony_helper', name: 'Harmony Helper', description: 'AI suggests harmony notes', icon: '✨', effect: 'harmony_helper', duration: 30, cost: 75, unlockLevel: 5 },
  { id: 'xp_multiplier', name: 'XP Boost', description: 'Double XP for the next lesson', icon: '🚀', effect: 'xp_multiplier', duration: 1, cost: 100, unlockLevel: 4 },
  { id: 'streak_saver', name: 'Streak Saver', description: 'Protect your streak from one miss', icon: '🔥', effect: 'streak_saver', duration: 1, cost: 40, unlockLevel: 3 },
  { id: 'time_freeze', name: 'Time Freeze', description: 'Pause the timer in challenge mode', icon: '❄️', effect: 'time_freeze', duration: 10, cost: 60, unlockLevel: 6 },
];

export const LEARNING_BADGES: LearningBadge[] = [
  { id: 'first_lesson', name: 'First Steps', description: 'Complete your first lesson', icon: '🌟', requirement: { type: 'lessons', value: 1 }, tier: 'bronze', xpReward: 25 },
  { id: 'lessons_10', name: 'Getting Started', description: 'Complete 10 lessons', icon: '📚', requirement: { type: 'lessons', value: 10 }, tier: 'bronze', xpReward: 50 },
  { id: 'lessons_50', name: 'Dedicated Student', description: 'Complete 50 lessons', icon: '🎓', requirement: { type: 'lessons', value: 50 }, tier: 'silver', xpReward: 150 },
  { id: 'lessons_100', name: 'Century Learner', description: 'Complete 100 lessons', icon: '💯', requirement: { type: 'lessons', value: 100 }, tier: 'gold', xpReward: 300 },
  { id: 'lessons_500', name: 'Music Scholar', description: 'Complete 500 lessons', icon: '🏛️', requirement: { type: 'lessons', value: 500 }, tier: 'platinum', xpReward: 1000 },
  
  { id: 'streak_3', name: 'Three Day Streak', description: '3 day practice streak', icon: '🔥', requirement: { type: 'streak', value: 3 }, tier: 'bronze', xpReward: 30 },
  { id: 'streak_7', name: 'Week Warrior', description: '7 day practice streak', icon: '🔥', requirement: { type: 'streak', value: 7 }, tier: 'silver', xpReward: 75 },
  { id: 'streak_30', name: 'Month Master', description: '30 day practice streak', icon: '💎', requirement: { type: 'streak', value: 30 }, tier: 'gold', xpReward: 250 },
  { id: 'streak_100', name: 'Century Streak', description: '100 day practice streak', icon: '👑', requirement: { type: 'streak', value: 100 }, tier: 'diamond', xpReward: 1000 },
  { id: 'streak_365', name: 'Year of Music', description: '365 day practice streak', icon: '🌟', requirement: { type: 'streak', value: 365 }, tier: 'diamond', xpReward: 5000 },
  
  { id: 'perfect_5', name: 'Perfect Five', description: '5 lessons with 100% accuracy', icon: '🎯', requirement: { type: 'perfect', value: 5 }, tier: 'bronze', xpReward: 50 },
  { id: 'perfect_25', name: 'Precision Player', description: '25 perfect lessons', icon: '🎯', requirement: { type: 'perfect', value: 25 }, tier: 'silver', xpReward: 150 },
  { id: 'perfect_100', name: 'Flawless Maestro', description: '100 perfect lessons', icon: '💎', requirement: { type: 'perfect', value: 100 }, tier: 'gold', xpReward: 500 },
  
  { id: 'ear_5', name: 'Keen Listener', description: 'Reach level 5 in Ear Training', icon: '👂', requirement: { type: 'skill', value: 5, skill: 'earTraining' }, tier: 'bronze', xpReward: 75 },
  { id: 'ear_10', name: 'Golden Ear', description: 'Reach level 10 in Ear Training', icon: '👂', requirement: { type: 'skill', value: 10, skill: 'earTraining' }, tier: 'silver', xpReward: 200 },
  { id: 'rhythm_5', name: 'Beat Keeper', description: 'Reach level 5 in Rhythm', icon: '🥁', requirement: { type: 'skill', value: 5, skill: 'rhythm' }, tier: 'bronze', xpReward: 75 },
  { id: 'rhythm_10', name: 'Rhythm Master', description: 'Reach level 10 in Rhythm', icon: '🥁', requirement: { type: 'skill', value: 10, skill: 'rhythm' }, tier: 'silver', xpReward: 200 },
  { id: 'improv_5', name: 'Creative Spirit', description: 'Reach level 5 in Improvisation', icon: '🎸', requirement: { type: 'skill', value: 5, skill: 'improvisation' }, tier: 'silver', xpReward: 100 },
  { id: 'improv_10', name: 'Improv Star', description: 'Reach level 10 in Improvisation', icon: '🎸', requirement: { type: 'skill', value: 10, skill: 'improvisation' }, tier: 'gold', xpReward: 300 },
  { id: 'harmony_5', name: 'Harmony Seeker', description: 'Reach level 5 in Harmony', icon: '🎼', requirement: { type: 'skill', value: 5, skill: 'harmony' }, tier: 'silver', xpReward: 100 },
  { id: 'harmony_10', name: 'Harmony Hero', description: 'Reach level 10 in Harmony', icon: '🎼', requirement: { type: 'skill', value: 10, skill: 'harmony' }, tier: 'gold', xpReward: 300 },
  
  { id: 'speed_10', name: 'Quick Fingers', description: 'Complete 10 speed runs', icon: '⚡', requirement: { type: 'mode', value: 10, mode: 'speed' }, tier: 'bronze', xpReward: 75 },
  { id: 'speed_50', name: 'Speed Demon', description: 'Complete 50 speed runs', icon: '⚡', requirement: { type: 'mode', value: 50, mode: 'speed' }, tier: 'silver', xpReward: 200 },
  { id: 'mirror_10', name: 'Mirror Master', description: 'Complete 10 mirror sessions', icon: '🪞', requirement: { type: 'mode', value: 10, mode: 'mirror' }, tier: 'bronze', xpReward: 75 },
  { id: 'zen_25', name: 'Mindful Musician', description: 'Complete 25 zen sessions', icon: '🧘', requirement: { type: 'mode', value: 25, mode: 'zen' }, tier: 'silver', xpReward: 150 },
  { id: 'improv_mode_20', name: 'Jam Master', description: 'Complete 20 improv sessions', icon: '🎸', requirement: { type: 'mode', value: 20, mode: 'improvisation' }, tier: 'gold', xpReward: 250 },
  
  { id: 'level_5', name: 'Rising Star', description: 'Reach level 5', icon: '⭐', requirement: { type: 'level', value: 5 }, tier: 'bronze', xpReward: 50 },
  { id: 'level_10', name: 'Skilled Player', description: 'Reach level 10', icon: '⭐', requirement: { type: 'level', value: 10 }, tier: 'silver', xpReward: 100 },
  { id: 'level_25', name: 'Expert Musician', description: 'Reach level 25', icon: '🏆', requirement: { type: 'level', value: 25 }, tier: 'gold', xpReward: 300 },
  { id: 'level_50', name: 'Virtuoso', description: 'Reach level 50', icon: '👑', requirement: { type: 'level', value: 50 }, tier: 'platinum', xpReward: 750 },
  { id: 'level_100', name: 'Legendary', description: 'Reach level 100', icon: '🌟', requirement: { type: 'level', value: 100 }, tier: 'diamond', xpReward: 2000 },
  
  { id: 'xp_1k', name: 'Dedicated Learner', description: 'Earn 1,000 XP', icon: '📚', requirement: { type: 'xp', value: 1000 }, tier: 'bronze', xpReward: 50 },
  { id: 'xp_10k', name: 'XP Champion', description: 'Earn 10,000 XP', icon: '🏅', requirement: { type: 'xp', value: 10000 }, tier: 'silver', xpReward: 200 },
  { id: 'xp_50k', name: 'XP Legend', description: 'Earn 50,000 XP', icon: '🎖️', requirement: { type: 'xp', value: 50000 }, tier: 'gold', xpReward: 500 },
  { id: 'xp_100k', name: 'Master Musician', description: 'Earn 100,000 XP', icon: '🎓', requirement: { type: 'xp', value: 100000 }, tier: 'platinum', xpReward: 1500 },
  
  { id: 'time_1h', name: 'Hour of Practice', description: 'Practice for 1 hour total', icon: '⏱️', requirement: { type: 'time', value: 60 }, tier: 'bronze', xpReward: 25 },
  { id: 'time_10h', name: 'Dedicated Practitioner', description: 'Practice for 10 hours', icon: '⏱️', requirement: { type: 'time', value: 600 }, tier: 'silver', xpReward: 150 },
  { id: 'time_100h', name: 'Practice Makes Perfect', description: 'Practice for 100 hours', icon: '⏱️', requirement: { type: 'time', value: 6000 }, tier: 'gold', xpReward: 500 },
  
  { id: 'notes_1k', name: 'Note Collector', description: 'Play 1,000 notes', icon: '🎹', requirement: { type: 'notes', value: 1000 }, tier: 'bronze', xpReward: 30 },
  { id: 'notes_10k', name: 'Melody Maker', description: 'Play 10,000 notes', icon: '🎹', requirement: { type: 'notes', value: 10000 }, tier: 'silver', xpReward: 150 },
  { id: 'notes_100k', name: 'Symphony Creator', description: 'Play 100,000 notes', icon: '🎹', requirement: { type: 'notes', value: 100000 }, tier: 'gold', xpReward: 500 },
  
  { id: 'combo_10', name: 'Combo Starter', description: 'Achieve 10x combo', icon: '🔗', requirement: { type: 'combo', value: 10 }, tier: 'bronze', xpReward: 50 },
  { id: 'combo_25', name: 'Combo Master', description: 'Achieve 25x combo', icon: '🔗', requirement: { type: 'combo', value: 25 }, tier: 'silver', xpReward: 150 },
  { id: 'combo_50', name: 'Combo Legend', description: 'Achieve 50x combo', icon: '🔗', requirement: { type: 'combo', value: 50 }, tier: 'gold', xpReward: 300 },
];
    ...
    lessons: [
      {
        ...
        variations: [
          { id: 'transpose_up', name: 'Higher Octave', transform: 'transpose', description: 'Try one octave higher', modifier: 1, unlockXp: 100, icon: '⬆️' },
        ],
      },
      {
        id: 'simple_intervals',
        ...
        variations: [
          { id: 'octave_jump', name: 'Octave Jump', transform: 'transpose', description: 'Try one octave higher', modifier: 1, unlockXp: 150, icon: '🎵' },
          { id: 'faster', name: 'Quick Fire', transform: 'tempo', description: 'Double speed challenge', modifier: 0.5, unlockXp: 200, icon: '⚡' },
        ],
      },
      {
        ...
        variations: [
          { id: 'reverse', name: 'Mirror Mode', transform: 'mirror', description: 'Play in reverse order', modifier: -1, unlockXp: 150, icon: '🪞' },
          { id: 'add_harmony', name: 'With Harmony', transform: 'harmony', description: 'Add bass support', modifier: 1, unlockXp: 200, icon: '🎼' },
        ],
      },
      {
        id: 'ascending_scales',
        ...
        practiceGoals: [{ mode: 'standard', target: 85 }, { mode: 'speed', target: 75 }],
        variations: [
          { id: 'speed_up', name: 'Fast Scales', transform: 'speed', description: 'Double tempo', modifier: 2, unlockXp: 200, icon: '⚡' },
        ],
      },
      {
    ...
    lessons: [
      {
        ...
        variations: [
          { id: 'faster_tempo', name: 'Faster', transform: 'tempo', description: 'Play at 1.5x speed', modifier: 1.5, unlockXp: 200, icon: '⚡' },
        ],
      },
      {
        id: 'happy_birthday',
      ...
      },
      {
        ...
        variations: [
          { id: 'mirror', name: 'Mirror Play', transform: 'mirror', description: 'Play the melody backwards', modifier: -1, unlockXp: 300, icon: '🪞' },
        ],
      },
      {
        id: 'canon_in_d',
    ...
    lessons: [
      {
        ...
        practiceGoals: [{ mode: 'standard', target: 90 }],
        variations: [
          { id: 'faster', name: 'Double Time', transform: 'tempo', description: 'Twice as fast', modifier: 2, unlockXp: 150, icon: '⚡' },
        ],
      },
      {
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        variations: [
          { id: 'speed_run', name: 'Dance Tempo', transform: 'speed', description: 'Full BPM challenge', modifier: 1.5, unlockXp: 350, icon: '⚡' },
        ],
      },
      {
        id: 'uptown_funk',
    ...
    lessons: [
      {
        ...
        variations: [
          { id: 'improvise', name: 'Improvise Ending', transform: 'improvise', description: 'Create your own ending', modifier: 1, unlockXp: 400, icon: '🎸' },
        ],
      },
      {
        id: 'jazz_lick_1',
